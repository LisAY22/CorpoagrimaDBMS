...
BEGIN
    ...
    INSERT INTO TuTabla (Fecha, Ventas, Costos_Ventas, Gastos_Administrativos, Gastos_Operacionales, Utilidad_Antes_Ingresos, Ingresos, Utilidad_Antes_ISR, ISR25, Utilidad_Neta)
